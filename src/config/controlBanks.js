...
const CONTROL_DEFS = [
  ...
  },
  {
    key: 'hihatOn',
    type: 'toggle',
    label: 'Hi-hat enabled',
    baseGestureRate: 1,
    gestureAdjustable: true,
    format: (value) => (value ? 'On' : 'Off'),
  },
  {
    key: 'hihatClosedLevel',
    type: 'number',
    label: 'HH closed level',
    min: 0.5,
    max: 3,
    step: 0.05,
    baseGestureRate: 0.2,
  ...
  {
    key: 'hihatClosedDecayMs',
    type: 'number',
    label: 'HH closed decay',
    min: 10,
    max: 80,
    step: 1,
    baseGestureRate: 8,
...
export const CONTROL_BANKS = Object.freeze([
  ...
  Object.freeze({
    key: 'kick',
    label: 'Percussion',
    controls: Object.freeze(['kickOn', 'snareOn', 'hihatOn']),
  }),
  Object.freeze({
    key: 'transport',
    label: 'General',
